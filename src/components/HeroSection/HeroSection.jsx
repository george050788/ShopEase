    ...
    <div
      ...
      <main className="px-10 lg:px-24 z-10">
        <div className="text-left">
          <h2 className="text-4xl text-white">T-shirt / Tops</h2>
        </div>
        ...
        <button className="border rounded border-black mt-6 hover:bg-white hover:text-black hover:border-black text-white bg-black w-44 h-12">
          Shop Now
        </button>
      </main>
    </div>
