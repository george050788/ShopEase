    ...
    <div>
      ...
      {!addAddress && <div>
        ...
        <div className='pt-4'>
          ...
          <div className='pt-4 grid grid-col-1 lg:grid-cols-4 md:grid-cols-3 gap-8 pb-10'>
            {
              userInfo?.addressList?.map((address, index) => {
                return (<div key={index} className='bg-gray-200 border rounded-lg p-4'>
                  ...
                  <div className='flex gap-2'>
                    ...
                    <button onClick={() => onDeleteAddress(address?.id)}
                      className='underline text-blue-900'>Remove</button>
                  </div>
                </div>)
              })
            }
